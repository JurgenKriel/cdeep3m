...
@test "caffepredict.sh run success on 16 .h5 files all gpus" {
   ...
   [ "${lines[16]}" = "--no-notice --delay 2 -N 6 -j 2 GLOG_logtostderr=\"{1}\" predict_seg_new.bin --model={2}/deploy.prototxt --weights={3} --data={4} --predict={5}/test.h5 --shift_axis=2 --shift_stride=1 --gpu={6}" ]
...
@test "caffepredict.sh run success on 16 .h5 files --gpu 1" {
   ...
   [ "${lines[16]}" = "--no-notice --delay 2 -N 6 -j 1 GLOG_logtostderr=\"{1}\"predict_seg_new.bin --model={2}/deploy.prototxt --weights={3} --data={4} --predict={5}/test.h5 --shift_axis=2 --shift_stride=1 --gpu={6}" ]
